...
1. Specify other Harbor configuration (e.g. admin password, hostname, persistence setting, etc.) in `harbor-values.yaml`. To customize Harbor insatllation, you could refer to the pass-through value setting in `Configuration` section.
